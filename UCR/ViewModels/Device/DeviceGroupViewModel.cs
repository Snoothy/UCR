...
namespace UCR.ViewModels.Device
{
    public class DeviceGroupViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<Core.Models.Device.Device> Devices { get; set; }

        public DeviceGroupViewModel(string title = null, Guid guid = new Guid())
        {
            Title = title;
            Groups = new ObservableCollection<DeviceGroupViewModel>();
            Devices = new ObservableCollection<Core.Models.Device.Device>();
        ...
        public static DeviceGroupViewModel FindDeviceGroupViewModelWithDevice(Collection<DeviceGroupViewModel> deviceGroupViewModels, Core.Models.Device.Device device)
        {
